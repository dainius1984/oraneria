          ...
          {mobileMenuOpen && (
            <>
              ...
              <motion.div
                ...
                className="fixed top-20 right-4 left-4 bg-[#FFFAF5] rounded-2xl shadow-2xl border border-orange-100/50 z-50 overflow-hidden max-h-[calc(100vh-6rem)] overflow-y-auto"
              >
