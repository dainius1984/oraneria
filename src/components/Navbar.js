  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="bg-[#FFFAF5]/90 backdrop-blur-md rounded-2xl px-8 py-4 shadow-lg border border-orange-100/30">
            ...
            >
              ...
              <div className="hidden md:flex items-center gap-3">
                <motion.a
                  ...
                  className="text-[#2F4F4F] hover:text-[#C86B46] transition-colors"
